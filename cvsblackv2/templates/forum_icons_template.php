...
define("IMAGE_profile", "<img src='".THEME_ABS."forum/profile.png' alt='".LAN_398."' title='".LAN_398."' style='border:0' />");
define("IMAGE_email", "<img src='".THEME_ABS."forum/email.png' alt='".LAN_397."' title='".LAN_397."' style='border:0' />");
...
define("IMAGE_edit", "<img src='".THEME_ABS."forum/edit.png' alt='".LAN_400."' title='".LAN_400."' style='border:0' />");
define("IMAGE_quote", "<img src='".THEME_ABS."forum/quote.png' alt='".LAN_401."' title='".LAN_401."' style='border:0' />");
...
define("IMAGE_newthread", "<img src='".THEME_ABS."forum/newthread.png' alt='".LAN_FORUM_2005."' title='".LAN_FORUM_2005."' style='border:0' />");
define("IMAGE_reply", "<img src='".THEME_ABS."forum/reply.png' alt='' title='' style='border:0' />");
